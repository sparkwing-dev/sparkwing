...
exclusive views of the unified stream.`,
	Flags: []FlagSpec{
		...
		{Name: "events-only", Desc: "Include event records and omit node body output", Group: "Filter"},
		{Name: "no-events", Desc: "Include node body output and omit event records", Group: "Filter"},
