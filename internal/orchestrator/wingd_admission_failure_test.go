...
func TestAdmissionFailure_NeverAdmissibleCarriesTheDaemonsArithmetic(t *testing.T) {
	err := admissionFailure(wingwire.AdmissionRequest{}, &wingdclient.AdmissionError{
	...
	bare := admissionFailure(wingwire.AdmissionRequest{}, &wingdclient.AdmissionError{Key: "never_admissible", Policy: wingwire.PolicyFail})
