...
var apiWriteRoutes = []string{
	...
	"PUT /api/v1/storage/quotas/{principal}/allowance",
	...
	"POST /api/v1/runs/{id}/nodes/{nodeID}/execution-finish",
	"POST /api/v1/runs/{id}/nodes/{nodeID}/execution-start",
	"POST /api/v1/runs/{id}/nodes/{nodeID}/finalize-ready",
	...
	"POST /api/v1/tokens/{prefix}/metered",
	"GET /api/v1/credits",
	...
	"GET /api/v1/credits/teams/{team}",
	"GET /api/v1/team/billing",
	"POST /api/v1/team/billing/checkout",
	...
	"POST /api/v1/me/identities/{provider}/link/complete",
	"DELETE /api/v1/me/identities/{provider}",
	"POST /api/v1/runs/{id}/cache-grant",
	"GET /api/v1/runs/{id}/log-access",
	"PATCH /api/v1/team",
	"DELETE /api/v1/team",
	...
	"POST /internal/storage/reserve",
	"POST /internal/storage/commit",
	"POST /internal/storage/release",
	"POST /internal/downloads/charge",
	"POST /internal/egress/totals",
	"GET /api/v1/signups",
	"PUT /api/v1/signups",
	...
	"POST /api/v1/runs/{id}/oidc-token",
	...
	"POST /api/v1/team/git-credentials/{host}/confirm",
	"DELETE /api/v1/team/git-credentials/{host}",
	"GET /api/v1/team/git-credentials/releases",
	"GET /api/v1/team/github-app",
	"POST /api/v1/team/github-app/connect",
	"POST /api/v1/team/github-app/connect/complete",
	"POST /api/v1/team/github-app/connect/available",
	"POST /api/v1/team/github-app/connect/select",
	"DELETE /api/v1/team/github-app/installations/{installation_id}",
	"GET /api/v1/team/github-app/installations/{installation_id}/repositories",
	"DELETE /api/v1/team/github-app/triggers",
	"GET /api/v1/team/github-app/triggers",
	"PUT /api/v1/team/github-app/triggers",
	"GET /api/v1/team/github-app/extra-repos",
	"PUT /api/v1/team/github-app/extra-repos",
