...
func TestLocalFleetSourceServesOnlyExactAuthenticatedSnapshot(t *testing.T) {
	...
	sparkwingDir, err := bincache.FetchPipelineWorkspaceSourceWithCredentials(gitcacheURL, proxy.URL, "private-cache-hop", "", fixture.repoURL, "main", fixture.sha, dest)
	if err != nil {
		t.Fatal(err)
	}
	...
	_, err = bincache.FetchPipelineWorkspaceSourceWithCredentials(gitcacheURL, proxy.URL, "wrong", "", fixture.repoURL, "main", fixture.sha, filepath.Join(fixture.root, "denied"))
	if err == nil {
