...
func (p *P) Plan(ctx context.Context, plan *sparkwing.Plan, _ sparkwing.NoInputs, _ sparkwing.RunContext) error {
	services.WithServicesAddrs(ctx, nil, nil)
	return nil
}`
