...
// safety: BW matches in either case because the branch convention spells it
// bw-<n>, and a branch name in a doc leaks the same private id as a comment.
