...
func TestSchemaV30CompositeRestoresExecutorEnrollmentPostgres(t *testing.T) {
	scoped := pgTestSchemaDSN(t)
	ctx := context.Background()
	st, err := store.OpenPostgres(ctx, scoped)
	if err != nil {
...
func TestSchemaV30CompositeRestoresClaimOffersPostgres(t *testing.T) {
	scoped := pgTestSchemaDSN(t)
	ctx := context.Background()
	st, err := store.OpenPostgres(ctx, scoped)
	if err != nil {
...
func TestSchemaV30CompositeRestoresAgentLossFieldsPostgres(t *testing.T) {
	scoped := pgTestSchemaDSN(t)
	ctx := context.Background()
	st, err := store.OpenPostgres(ctx, scoped)
	if err != nil {
