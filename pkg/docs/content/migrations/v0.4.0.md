...
5. **Update CLI usage.** [cli-flag-renames](#cli-flag-renames) and
   [cli-retired-flags](#cli-retired-flags) cover scripts, CI, and
   shell aliases that pinned old flag names.
