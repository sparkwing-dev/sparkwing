...
| [v0.46.0](v0.46.0.md) | 2026-09-08 | `sparkwing runs submit` is removed; `sparkwing run <pipeline> --sw-detached` is the detached launch, with the submit-only flags moved into the `--sw-` namespace. |
