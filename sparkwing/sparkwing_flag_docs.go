...
var sparkwingFlagDocs = []SparkwingFlagDoc{
	...
	{Name: "sw-pipeline-ref", Argument: "REF", Desc: "Detached only: compile the pipeline at REF and execute it in this checkout; cannot be combined with --sw-ref", Group: "Source"},
