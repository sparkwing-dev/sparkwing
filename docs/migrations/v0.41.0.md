...
Sparkwing v0.41.0 advances the runs store from schema 23 to 31 and tightens
Fleet, controller, execution, and local-process trust boundaries. Upgrade
every binary sharing a runs store together before resuming work.
